    ...
    <div className="p-6 max-w-6xl mx-auto space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <Link href={`/instructor/courses/${id}/lessons/new`}>
          <button type="button" aria-label="Nueva lección" className="flex items-center gap-2 px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary/90 transition">
            <PlusCircle size={18} />
            Nueva lección
          </button>
        </Link>
                ...
                >
                  ...
                  <td className="p-3 text-right space-x-3">
                    <Link href={`/instructor/courses/${id}/lessons/${lesson.id}/edit`}>
                      <button type="button" aria-label="Editar lección" className="text-blue-500 hover:text-blue-700">
                        <Pencil size={18} />
                      </button>
                    </Link>
                    <button type="button" aria-label="Eliminar lección" className="text-red-500 hover:text-red-700">
                      <Trash2 size={18} />
                    </button>
                  </td>
                </tr>
