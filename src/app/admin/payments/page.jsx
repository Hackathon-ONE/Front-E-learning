        ...
        <div className="mb-4 sm:mb-6">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
              <button type="button" aria-label="Exportar" className="px-4 py-2.5 cursor-pointer bg-[var(--color-primary)] hover:bg-[var(--color-primary-hover)] text-white rounded-lg text-sm font-medium transition-colors">
                Exportar
              </button>
              <button type="button" aria-label="Filtrar" className="px-4 py-2.5 cursor-pointer border border-[var(--color-muted)] hover:bg-[var(--color-muted)] text-[var(--color-text)] rounded-lg text-sm font-medium transition-colors">
                Filtrar
              </button>
            </div>
          </div>
        ...
        <div className="mb-6 p-4 bg-[var(--color-card-primary)] rounded-xl shadow-sm border border-[var(--color-muted)]">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="flex items-end">
              <button type="button" aria-label="Aplicar filtros" className="w-full cursor-pointer p-2.5 bg-[var(--color-primary)] hover:bg-[var(--color-primary-hover)] text-white rounded-lg text-sm font-medium transition-colors">
                Aplicar Filtros
              </button>
            </div>
          </div>
                ...
                {payments.map((payment) => (
                  ...
                  >
                    ...
                    <td className="px-2 sm:px-4 py-3 whitespace-nowrap text-right text-sm font-medium">
                      <button type="button" aria-label="Ver detalles" className="cursor-pointer text-[var(--color-primary)] hover:text-[var(--color-primary-hover)] text-xs sm:text-sm">
                        Ver detalles
                      </button>
                    </td>
                  </tr>
