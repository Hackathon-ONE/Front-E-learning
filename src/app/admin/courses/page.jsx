      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-4 sm:mb-6">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <button aria-label="Nuevo curso" className="w-full sm:w-auto px-4 py-2.5 bg-[var(--color-primary)] hover:bg-[var(--color-primary-hover)] text-white rounded-lg text-sm sm:text-base font-medium transition-colors">
              + Nuevo Curso
            </button>
            </Link>
          </div>
          ...
          {courses.map((course) => (
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                <button aria-label="Editar curso" className="flex-1 px-3 py-2 text-xs sm:text-sm bg-[var(--color-primary)] hover:bg-[var(--color-primary-hover)] text-[var(--color-text)] rounded-lg transition-colors">
                  Editar
                </button>
                <button aria-label="Ver curso" className="flex-1 px-3 py-2 text-xs sm:text-sm border border-[var(--color-muted)] bg-[var(--color-secondary)] hover:bg-[var(--color-secondary-hover)] text-[var(--color-text)] rounded-lg transition-colors">
                  Ver
                </button>
              </div>
            </div>
        ...
        <div className="mt-8 flex justify-center">
          <div className="flex items-center space-x-2" aria-label="Paginación">
            <button aria-label="Anterior" className="px-3 py-2 text-sm border border-[var(--color-muted)] text-[var(--color-text)] rounded-lg hover:bg-[var(--color-muted)] transition-colors">
              Anterior
            </button>
            <button aria-label="Página 1" className="px-3 py-2 text-sm bg-[var(--color-primary)] text-[var(--color-text)] rounded-lg">
              1
            </button>
            <button aria-label="Página 2" className="px-3 py-2 text-sm border border-[var(--color-muted)] text-[var(--color-text)] rounded-lg hover:bg-[var(--color-muted)] transition-colors">
              2
            </button>
            <button aria-label="Página 3" className="px-3 py-2 text-sm border border-[var(--color-muted)] text-[var(--color-text)] rounded-lg hover:bg-[var(--color-muted)] transition-colors">
              3
            </button>
            <button aria-label="Siguiente" className="px-3 py-2 text-sm border border-[var(--color-muted)] text-[var(--color-text)] rounded-lg hover:bg-[var(--color-muted)] transition-colors">
              Siguiente
            </button>
          </div>
        </div>
